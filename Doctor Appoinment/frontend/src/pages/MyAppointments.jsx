...
// use when we write backend for appointment booking system
...
const MyAppointments = () => {
  ...
  const { backendUrl, token, getDoctorsData } = useContext(AppContext) // doctors data
  ...
  const getUserAppointments = async () => {
    try {
      ...
      if (data.success) {
        setAppointments(data.appointments.reverse())   // recently added appointments will be displayed at the top.....
  ...
  // whenever myAppointments page get loaded...
  useEffect(() => {
    if (token) {
      getUserAppointments()
    }
